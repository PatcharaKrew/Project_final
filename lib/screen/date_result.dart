...
class AppointmentScreen extends StatefulWidget {
  ...
  AppointmentScreen({required this.quizSet,required this.userId,required this.resultProgram,required this.userName});
      ...
      try {
        final response = await http.post(
          ...
          body: jsonEncode({
            ...
            'appointment_date': _selectedDay!
                .toIso8601String()
                .substring(0, 10), // ใช้วันที่ที่ผู้ใช้เลือก
          }),
        );
